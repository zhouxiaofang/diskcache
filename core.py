...
import warnings
import zlib
from dvc_data.hashfile.zfang_gol import zfang_gol
...
class Cache:
    ...
    def set(self, key, value, expire=None, read=False, tag=None, retry=False):
        ...
        with self._transact(retry, filename) as (sql, cleanup):
            ...
            if rows:
                ...
                # e1 = time.time()
                # zfang_gol.set_value("sqlite_store", zfang_gol.get_value("sqlite_store") + (e1 - s1))
    ...
    def commit(self): #add zhoufang 20230210
